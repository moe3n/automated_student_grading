...
Original file is located at
    https://colab.research.google.com/drive/1aHX9zm8Tpcqdr2-ZfrGAFlLaVIjvIsyo
"""
...
def tokenization(s1, s2):
    ...
    s2 = [token for token in tokens2 if token not in string.punctuation]
...
if __name__ == "__main__":
    ...
    # vectorizer = TfidfVectorizer()
    # tfidf_matrix, feature_names = calculate_tfidf_matrix(s1 + s2)
